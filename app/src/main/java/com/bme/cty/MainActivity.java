...
import com.bme.cty.core.WeightDBHelper;
import com.bme.cty.widget.InputDialog;
import com.bme.cty.widget.SearchDialog;
...
public class MainActivity extends TabActivity implements OnCheckedChangeListener {
    ...
    private static final String TAB_TAG_DIAGNOSE = "iDiagnose";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent iDiagnose = new Intent(this, DiagnoseActivity.class);
        mTabHost.addTab(mTabHost.newTabSpec(TAB_TAG_DIAGNOSE)
                .setIndicator(getResources().getString(R.string.menu_diagnose), getResources().getDrawable(R.drawable.menu_diagnose_selector))
                .setContent(iDiagnose));
    ...
    public void onCheckedChanged(RadioGroup group, int checkedId) {
        switch(checkedId){
        case R.id.MenuButtonDiagnose:
             this.mTabHost.setCurrentTabByTag(TAB_TAG_DIAGNOSE);
             break;
